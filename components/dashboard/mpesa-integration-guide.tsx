...
import { Copy, Check, Smartphone, Key, FileText, RefreshCw, AlertCircle, EyeOff, Loader2, Lock, ArrowRight } from "lucide-react";
    ...
    <div className="bg-white rounded-2xl border border-[#E2E2FF] shadow-sm overflow-hidden flex flex-col h-full">
      <div className="px-5 py-4 border-b border-[#E2E2FF] bg-[#F0F0FF]/20 flex items-center justify-between shrink-0">
        <div>
          ...
          <p className="text-xs text-[#33375C]/60 mt-0.5 font-medium">Automate M-Pesa transaction syncing with MacroDroid</p>
        </div>
          ...
          <div className="md:col-span-3 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-[#0A0D27] text-sm">
                Configure M-Pesa {setupMethod === "sms" ? "SMS" : "Notification"} Forwarder
              </h3>
            </div>
            {setupMethod === "sms" ? (
