        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              ...
              Create a global integer variable named <code className="bg-[#FEF9C3] px-1.5 py-0.5 rounded text-[#EA580C] font-semibold">http_response</code> (default value 0) and a global string variable named <code className="bg-[#FEF9C3] px-1.5 py-0.5 rounded text-[#EA580C] font-semibold">queue_contents</code> (default empty).
            </p>
            {triggerMethod === "notifications" && (
          ...
          <div className="md:col-span-3 space-y-2">
            ...
            {triggerMethod === "sms" ? (
              <div className="text-xs text-[#33375C]/75 leading-relaxed pl-7 space-y-2">
                <p>
                  Set up a macro triggered by **SMS Received** (incoming SMS matching sender <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">MPESA</code>).
                </p>
...
{`{
  ...
  "timestamp": "[sms_time]"
                ...
                <p>
                  • **Fallback Action:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">http_response != 200</code>, write to file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">/storage/emulated/0/mpesa_queue.txt</code> with content: <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">[sms_message]|||[sms_time]</code>.
                </p>
              </div>
            ) : (
              <div className="text-xs text-[#33375C]/75 leading-relaxed pl-7 space-y-2">
                <p>
                  Set up a macro triggered by **Notification Received** (from your default messages app matching text <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">MPESA</code>). Ensure you enable **Prevent multiple triggers** in Trigger options.
                </p>
                <p className="font-medium text-[#0A0D27]">Action: HTTP Request (POST)</p>
                <ul className="list-disc pl-4 space-y-1 text-[11px] text-[#33375C]/70">
                  <li><strong>Content Type:</strong> application/json</li>
...
{`{
  ...
  "timestamp": "[notification_timestamp]"
                ...
                <p>
                  • **Fallback Action:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">http_response != 200</code>, write to file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">/storage/emulated/0/mpesa_queue.txt</code> with content: <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">[notification_text]|||[notification_timestamp]</code>.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              ...
              <br />• Read file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">mpesa_queue.txt</code> into global string variable <code className="bg-[#FEF9C3] px-1.5 rounded text-[#EA580C] font-semibold">queue_contents</code>.
...
{`{
  ...
  "source": "macrodroid_sync"
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              • **Cleanup:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">http_response == 200</code>, clear the queue file by overwriting it to be completely empty.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
