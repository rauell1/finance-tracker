...
export function BankIntegrationGuide() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#DCFCE7] shadow-sm overflow-hidden flex flex-col h-full">
      <div className="px-5 py-4 border-b border-[#DCFCE7] bg-[#FEF9C3]/20 flex items-center justify-between shrink-0">
        <div>
        ...
        <span className="text-[10px] font-bold uppercase tracking-wider bg-[#FEF9C3] border border-[#DCFCE7] text-[#EA580C] px-2.5 py-0.5 rounded-md">
      ...
      <div className="p-6 space-y-6 flex-1 overflow-y-auto">
        {/* Platform toggle */}
        <div className="bg-[#FEF9C3]/20 border border-[#DCFCE7] rounded-xl p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
          ...
          <div className="flex bg-[#FEF9C3]/50 border border-[#DCFCE7] p-1 rounded-xl shrink-0">
            <button
              ...
              className={`py-1 px-3 text-xs font-semibold rounded-lg transition-colors duration-150 flex items-center gap-1.5 ${
                platform === "macrodroid"
                  ...
                  : "text-[#33375C]/60 hover:text-[#EA580C]"
              }`}
            >
        ...
        {platform === "sms_gateway" && (
          <div className="bg-[#FEF9C3]/20 border border-[#DCFCE7] rounded-xl p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in duration-200">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            <div className="flex items-center gap-2">
              <span className="h-5 w-5 rounded-full bg-[#FEF9C3] border border-[#DCFCE7] flex items-center justify-center text-xs font-bold text-[#EA580C]">1</span>
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              Download and install **MacroDroid** from the Google Play Store. Create a global integer variable named <code className="bg-[#FEF9C3] px-1.5 py-0.5 rounded text-[#EA580C] font-semibold">bank_http_response</code> (default value 0) which tracks the webhook response code, and a global string variable named <code className="bg-[#FEF9C3] px-1.5 py-0.5 rounded text-[#EA580C] font-semibold">queue_contents</code> (default empty).
            </p>
            {triggerMethod === "notifications" && (
          ...
          <div className="md:col-span-2 flex justify-center">
            <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
              <div className="h-3 w-16 bg-slate-200 rounded-full mx-auto mb-3" />
              <div className="bg-white border border-[#DCFCE7] rounded-lg p-2 text-center">
                <Smartphone className="h-7 w-7 text-[#EA580C] mx-auto animate-pulse" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            <div className="flex items-center gap-2">
              <span className="h-5 w-5 rounded-full bg-[#FEF9C3] border border-[#DCFCE7] flex items-center justify-center text-xs font-bold text-[#EA580C]">2</span>
            ...
            <div className="pl-7 mt-3 space-y-2">
              {!revealed ? (
                <button
                  ...
                  disabled={loadingUrl}
                  className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-lg bg-[#FEF9C3] border border-[#DCFCE7] text-[#EA580C] hover:bg-[#DCFCE7] transition-colors disabled:opacity-50"
                >
                  {loadingUrl ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-1.5 w-full max-w-md bg-[#FEF9C3]/30 border border-[#DCFCE7] rounded-xl px-3 py-1.5">
                    <input
                      type="text"
                      value={activeUrl ?? ""}
                      readOnly
                    ...
                    <button
                      ...
                      className="h-7 w-7 rounded-lg bg-white border border-[#DCFCE7] hover:bg-[#FEF9C3]/40 flex items-center justify-center shadow-sm shrink-0 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="h-7 w-7 rounded-lg bg-white border border-[#DCFCE7] hover:bg-rose-50 hover:border-rose-200 hover:text-rose-600 flex items-center justify-center shadow-sm shrink-0 transition-colors disabled:opacity-50"
                    >
          ...
          <div className="md:col-span-2 flex justify-center">
            <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
              <div className="h-3 w-16 bg-slate-200 rounded-full mx-auto mb-3" />
              <div className="bg-white border border-[#DCFCE7] rounded-lg p-2 text-left">
                <div className="flex items-center gap-1 border-b border-[#DCFCE7] pb-1">
                ...
                <div className="mt-1.5">
                  ...
                  <div className="bg-[#FEF9C3] text-[#EA580C] text-[7px] font-bold px-1.5 py-0.5 rounded inline-block mt-0.5">
                    POST
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            <div className="flex items-center gap-2">
              <span className="h-5 w-5 rounded-full bg-[#FEF9C3] border border-[#DCFCE7] flex items-center justify-center text-xs font-bold text-[#EA580C]">3</span>
            ...
            {triggerMethod === "sms" ? (
              <div className="text-xs text-[#33375C]/75 leading-relaxed pl-7 space-y-2">
                <p>
                  Set up a macro triggered by **SMS Received** (matching bank senders like <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">DTB</code>, <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">SBMBANK</code>, or <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">IANDMBANK</code>).
                </p>
                ...
                <pre className="bg-[#FEF9C3]/30 border border-[#DCFCE7] p-2.5 rounded-lg text-[#33375C]/80 font-mono text-[9px] leading-normal overflow-x-auto">
{`{
  "message": "[sms_message]",
  "timestamp": "[sms_time]",
  "source": "bank_sms",
  "sender": "[sms_sender]"
                ...
                <p>
                  • **Fallback Action:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">bank_http_response != 200</code>, write to file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">/storage/emulated/0/bank_queue.txt</code> with content: <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">[sms_message]|||[sms_time]</code>.
                </p>
              </div>
            ) : (
              <div className="text-xs text-[#33375C]/75 leading-relaxed pl-7 space-y-2">
                <p>
                  Set up a macro triggered by **Notification Received** (from your default messages app matching bank title senders <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">DTB</code>, <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">SBMBANK</code>, or <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">IANDMBANK</code>). Ensure you enable **Prevent multiple triggers** in Trigger options.
                </p>
                <p className="font-medium text-[#0A0D27]">Action: HTTP Request (POST)</p>
                <ul className="list-disc pl-4 space-y-1 text-[11px] text-[#33375C]/70">
                  <li><strong>Content Type:</strong> application/json</li>
...
{`{
  ...
  "sender": "[notification_title]"
                ...
                <p>
                  • **Fallback Action:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">bank_http_response != 200</code>, write to file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">/storage/emulated/0/bank_queue.txt</code> with content: <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">[notification_text]|||[notification_timestamp]</code>.
                </p>
              </div>
            )}
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
              <div className="h-3 w-16 bg-slate-200 rounded-full mx-auto mb-3" />
              <div className="bg-white border border-[#DCFCE7] rounded-lg p-2 text-left">
                <div className="flex items-center gap-1 pb-1 border-b border-[#DCFCE7]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
          <div className="md:col-span-3 space-y-2">
            <div className="flex items-center gap-2">
              <span className="h-5 w-5 rounded-full bg-[#FEF9C3] border border-[#DCFCE7] flex items-center justify-center text-xs font-bold text-[#EA580C]">4</span>
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              ...
              <br />• Read file <code className="bg-[#FEF9C3] px-1 rounded text-slate-600">bank_queue.txt</code> into global string variable <code className="bg-[#FEF9C3] px-1.5 rounded text-[#EA580C] font-semibold">queue_contents</code>.
...
{`{
  ...
  "source": "bank_sync"
            ...
            <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
              • **Cleanup:** If <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">bank_http_response == 200</code>, clear the queue file by overwriting it to be completely empty.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
        <div className="md:col-span-3 space-y-2">
          ...
          <p className="text-xs text-[#33375C]/75 leading-relaxed pl-7">
            ...
            <a href="https://play.google.com/store/apps/details?id=app.sms.gateway" target="_blank" rel="noopener noreferrer" className="text-[#EA580C] underline">Google Play</a>{" "}
            or{" "}
            <a href="https://f-droid.org/packages/app.sms.gateway/" target="_blank" rel="noopener noreferrer" className="text-[#EA580C] underline">F-Droid</a>. 
            You can also check the project on <a href="https://github.com/capcom6/android-sms-gateway" target="_blank" rel="noopener noreferrer" className="text-[#EA580C] underline">GitHub</a>, visit the <a href="https://sms-gate.app" target="_blank" rel="noopener noreferrer" className="text-[#EA580C] underline">Official Website</a>, or read the <a href="https://docs.sms-gate.app" target="_blank" rel="noopener noreferrer" className="text-[#EA580C] underline">Documentation</a>.
          </p>
        </div>
        <div className="md:col-span-2 flex justify-center">
          <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
            <div className="h-3 w-16 bg-slate-200 rounded-full mx-auto mb-3" />
            <div className="bg-white border border-[#DCFCE7] rounded-lg p-2 text-center">
              <Smartphone className="h-7 w-7 text-[#EA580C] mx-auto" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start border-t border-[#DCFCE7]/60 pt-5">
            ...
            <div className="md:col-span-2 flex justify-center">
              <div className="w-full max-w-[180px] border border-[#DCFCE7] bg-[#FEF9C3]/10 rounded-xl p-3 shadow-inner relative select-none">
                <div className="h-3 w-16 bg-slate-200 rounded-full mx-auto mb-3" />
                <div className="bg-white border border-[#DCFCE7] rounded-lg p-2 text-left">
                  <div className="flex items-center gap-1.5 pb-1 border-b border-[#DCFCE7]">
...
{`curl -X POST -u <username>:<password> \\
  ...
  http://<device_local_ip>:8080/webhooks`}
                ...
                <p>Replace <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">&lt;username&gt;</code>, <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">&lt;password&gt;</code>, and <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">&lt;device_local_ip&gt;</code> with the values from Step 2.</p>
...
{`curl -X POST -u <username>:<password> \\
  ...
  https://api.sms-gate.app/3rdparty/v1/webhooks`}
                ...
                <p>Replace <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">&lt;username&gt;</code> and <code className="bg-[#FEF9C3] px-1 rounded text-[#EA580C] font-semibold">&lt;password&gt;</code> with the cloud credentials generated in Step 2.</p>
      ...
      {platform === "macrodroid" && (
      <div className="bg-emerald-50/50 border-t border-[#DCFCE7] p-4 px-6 flex items-start gap-3 shrink-0">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[11px] text-[#33375C]/70 leading-relaxed">
            The batch endpoint splits entries using the new line delimiter and parses individual elements separated by <code className="bg-[#FEF9C3] px-1 rounded">|||</code>. Make sure your MacroDroid write-to-file matches this pattern exactly!
          </p>
        </div>
      </div>
      )}
