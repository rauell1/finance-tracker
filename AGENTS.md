...
- M-PESA (`main`): **can go negative up to −KES 1,900** (Safaricom Fuliza overdraft; ceiling is the per-account `accounts.fuliza_limit` field — currently 1900, bumped from 1500 on 2026-07-23)
