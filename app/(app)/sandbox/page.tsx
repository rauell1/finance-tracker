...
// Initial realistic default values matching the main screenshot
const INITIAL_ACCOUNTS = [
  { account_id: "1", account_code: "main", name: "M-Pesa", balance: 5047.36, income: 27392.17, expense: 39931.73 },
  { account_id: "2", account_code: "kcb_mpesa", name: "KCB M-Pesa", balance: 100.00, income: 100.00, expense: 0 },
  { account_id: "3", account_code: "mshwari", name: "M-Shwari", balance: 0.27, income: 0, expense: 0 },
  { account_id: "4", account_code: "bank_a", name: "DTB Bank", balance: 12.07, income: 12.07, expense: 0 },
  { account_id: "5", account_code: "bank_b", name: "I&M Bank", balance: 0.20, income: 0.20, expense: 0 },
  { account_id: "6", account_code: "bank_c", name: "SBM Bank", balance: 9.99, income: 0, expense: 0 }
];

const INITIAL_TRANSACTIONS = [
  {
    id: "tx-1",
    description: "Paid to Wanticiah Distributors",
    amount: 300.00,
    txn_type: "expense",
  ...
  {
    id: "tx-2",
    description: "Paid to Tunnel Fast Food",
    amount: 400.00,
    txn_type: "expense",
  ...
  {
    id: "tx-5",
    description: "Received from Sonia Otieno",
    amount: 2300.00,
    txn_type: "income",
...
const INITIAL_DEBTS: any[] = [
  {
    id: "d-1",
    creditor: "DTB Credit Card",
    current_balance: 25000,
    credit_limit: 50000,
    interest_rate: 14,
    min_payment: 2500,
    due_date: "2026-07-28",
    source_identifier: "dtb_card",
...
const INITIAL_SAVINGS_GOALS = [
  { id: "sg-1", name: "Emergency Fund", target_amount: 100000, current_amount: 45000, progress: 45, is_completed: false },
  { id: "sg-2", name: "Car Fund", target_amount: 500000, current_amount: 120000, progress: 24, is_completed: false }
];
...
const INITIAL_INSIGHTS: any[] = [
  {
    ...
    content: "Other Expense is 124% above budget. Review your non-essential spending.",
    severity: "critical" as const,
    recommendation: "Recategorize uncategorized transactions to identify leaks.",
    potential_savings: 1200
  },
  {
    id: "in-2",
    title: "Recurring Charge Detected",
    content: "YouTube Premium Subscription appears monthly at KES 289.00.",
    severity: "info" as const,
    recommendation: "Cancel subscriptions you do not use regularly.",
    potential_savings: 289
  }
];

const TEMPLATES = [
  {
    label: "Transfer KES 20 to KCB Savings (Demo)",
    text: "UGELAAZW9S Confirmed. Ksh20.00 transfered to KCB M-PESA account on 14/7/26 at 4:00 AM. New M-PESA balance is Ksh5,047.36, new KCB M-PESA Saving account balance is Ksh120.00."
  },
  {
    label: "Send KES 1,500 to DTB Bank (Demo)",
    text: "UGELAAYX8A Confirmed. Ksh1,500.00 sent to DTB Bank for account 0123456789 on 14/7/26 at 4:10 AM. New M-PESA balance is Ksh3,547.36."
  },
  {
    label: "Receive salary of KES 45,000 (Demo)",
    text: "UGELAABB2C Confirmed. Ksh45,000.00 received from RAUELL SYSTEMS on 14/7/26 at 8:00 AM. New M-PESA balance is Ksh48,547.36."
  }
];
...
export default function SandboxPage() {
  ...
  const [logText, setLogText] = useState<string[]>(["Sandbox demo environment loaded successfully."]);
  ...
  function handleReset() {
    ...
    log("Demo database reset to initial values.");
    toast.success("Simulation sandbox reset successfully.");
  }

  // Simplified browser-safe parser mimicking route parsing logic
  function runSimulation() {
    ...
    const receipt = receiptMatch ? receiptMatch[1] : "MOCK" + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    setAccounts(prev => prev.map(acc => {
      ...
      // Update balances using stated balances if matched
    ...
    // Update savings progress if KCB savings was modified
    if (kcbBal !== null) {
      setSavingsGoals(prev => prev.map(g => {
        if (g.name === "Emergency Fund") {
          const newCurrent = g.current_amount + (kcbBal - 100); // Diff from start
    ...
    // Trigger dynamic simulation events
    ...
    if (txnType === "expense") {
      setBudgets(prev => prev.map(b => {
        if (b.category?.name === "Other Expense") {
          ...
          const status = newSpent > b.amount ? "over" : "safe";
    ...
    // Trigger mock AI Insights update if high value
    if (amount > 1000) {
      setInsights(prev => [
        {
          id: "in-" + Math.random(),
          title: "AI Spending Warning",
          content: `Large expense of KES ${amount} processed. This represents a substantial deviation.`,
          severity: "warning" as const,
          recommendation: "Review large transfers inside the dashboard analytics page.",
    ...
    toast.success(`Processed: ${receipt} confirmed. Balances updated.`);
  }
  ...
  const trendData = [
    { month: "Jan", income: 20000, expense: 18000, net: 2000 },
    { month: "Feb", income: 22000, expense: 19000, net: 3000 },
    { month: "Mar", income: 24000, expense: 21000, net: 3000 },
    { month: "Apr", income: 21000, expense: 23000, net: -2000 },
    { month: "May", income: 26000, expense: 25000, net: 1000 },
  ...
  return (
    <div className="space-y-6 sm:space-y-7">
      ...
      <div className="bg-gradient-to-br from-indigo-50/60 via-white to-purple-50/60 border border-indigo-100 rounded-3xl shadow-xl p-6 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-indigo-100/50 pb-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-extrabold text-[#0A0D27] text-lg tracking-tight">Real-Time Simulation Sandbox</h3>
      ...
      {/* Render the actual Dashboard UI using client state */}
      <HeroBanner
      ...
      <section>
        <div className="flex items-center gap-2 mb-3.5">
          ...
          <h2 className="text-sm font-bold text-foreground">Sandbox Account Balances</h2>
        </div>
