        ...
        <div className="space-y-10 text-[#33375C] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">1.</span> Acceptance of Terms
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">2.</span> Description of Service
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">3.</span> User Registration & Restricted Access
            </h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Notify us immediately at <a href="mailto:privacy@rauell.systems" className="text-[#EA580C] hover:underline font-semibold">privacy@rauell.systems</a> if you suspect any unauthorized access to your account.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">4.</span> SMS Forwarding & Webhook Security Responsibilities
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">5.</span> Privacy & Data Compliance
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">6.</span> Intellectual Property Rights
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">7.</span> Disclaimers & No Financial Advice
            </h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">8.</span> Limitation of Liability
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">9.</span> Governing Law & Jurisdiction
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">10.</span> Changes to Terms
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#0A0D27] flex items-center gap-2">
              <span className="text-[#EA580C]">11.</span> Contact Us
            </h2>
            <p>
            ...
            <div className="border border-[#DCFCE7] rounded-xl p-5 bg-[#FEF9C3]/10 text-sm space-y-1">
              ...
              <p><strong>Contact Email:</strong> <a href="mailto:privacy@rauell.systems" className="text-[#EA580C] hover:underline">privacy@rauell.systems</a></p>
            </div>
          </section>
        </div>
      </main>
      ...
      <footer className="border-t border-[#DCFCE7] bg-white py-10 relative z-10 w-full mt-auto">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6 text-sm text-[#33375C]/80">
          ...
          <nav aria-label="Footer navigation" className="flex items-center gap-6 font-semibold">
            ...
            <Link href="/terms" className="text-[#EA580C] hover:text-[#EA580C]">Terms of Service</Link>
