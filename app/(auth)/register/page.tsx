...
export const metadata: Metadata = {
  ...
  description:
    "Create your free FinTrack account. Manage your personal finance command center: track income, expenses, and budgets across M-Pesa, bank, and cash.",
  alternates: {
